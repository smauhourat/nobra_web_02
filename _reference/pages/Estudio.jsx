// Estudio — historia + fundadores + toolkit (BIM, software) + valores
const FOUNDERS = [
  {
    n: 'Novoa',
    full: 'Mat. arq. Novoa',
    role: 'Socio · Proyecto y obra',
    bio:
      'Seis años de experiencia profesional en estudios de vivienda y multifamiliar de la región. ' +
      'Antes de fundar Nobra trabajó como project leader en obras residenciales de hasta 1.500 m².',
    meta: [
      ['Matrícula', 'CAPBA · D-V'],
      ['Especialidad', 'Vivienda · Obra'],
  ...
  },
  {
    ...
    meta: [
      ['Matrícula', 'CAPBA · D-V'],
      ['Especialidad', 'Interiorismo · Retail'],
      ['Software', 'SketchUp · Twinmotion'],
    ],
    v: 2,
  },
];
...
function Estudio({ onNav }) {
  return (
    <div className="nb-page" data-screen-label="04 Estudio">
      <section className="nb-page-hero">
        ...
        <div className="nb-page-hero-meta">
          <div className="nb-page-hero-meta-row">
            <span className="nb-page-hero-meta-k">Socios</span>
            <span className="nb-page-hero-meta-v">02 · Novoa &amp; Bravin</span>
          </div>
          <div className="nb-page-hero-meta-row">
            <span className="nb-page-hero-meta-k">Fundación</span>
          ...
          <div className="nb-page-hero-meta-row">
            ...
            <span className="nb-page-hero-meta-v">CAPBA · D-V</span>
          </div>
        </div>
      </section>
      ...
      <section className="nb-estudio-intro">
        <div className="nb-estudio-intro-side">
          ...
          <h2 className="nb-h2" style={{marginTop: 20}}>
            Por qué Nobra.
          </h2>
        </div>
      ...
      <section style={{
        background: 'var(--nobra-blue)',
        color: 'var(--bone)',
        padding: 'clamp(80px,10vw,140px) clamp(20px,5vw,80px)',
        textAlign: 'center',
      }}>
        <span className="nb-eyebrow nb-eyebrow-num inv" style={{justifyContent: 'center'}}>
