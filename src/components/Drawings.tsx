...
export function DrawPlan({ variant = 1 }: { variant?: number }) {
  const plans = [
...
export function DrawSection({ variant = 1 }: { variant?: number }) {
  const sections = [
    <g key="1" fill="none" stroke="currentColor" strokeWidth={STROKE}>
...
export function DrawAxon({ variant = 1 }: { variant?: number }) {
  const axons = [
    <g key="1" fill="none" stroke="currentColor" strokeWidth={STROKE}>
...
export function DrawDetail({ variant = 1 }: { variant?: number }) {
  const details = [
    <g key="1" fill="none" stroke="currentColor" strokeWidth={STROKE}>
      <line x1="10" y1="10" x2="10" y2="64" />
      <line x1="10" y1="10" x2="90" y2="10" />
      <rect x="10" y="10" width="80" height="54" fill="none" opacity="0.15" />
...
export function DrawPortrait({ variant = 1 }: { variant?: number }) {
  const v = (variant - 1) % 2
  return (
...
export function ToolMark({ kind }: { kind: string }) {
