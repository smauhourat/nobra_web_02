...
interface Project {
  ...
  program: string; desc: string; drawings: Drawing[]
}

const PROYECTOS: Project[] = [
  {
    id: 'lp01', num: 'P—01', title: 'Vivienda LP—01', place: 'La Plata, BA',
    kind: 'Vivienda unifamiliar', type: 'residencial', year: '2026', stage: 'Anteproyecto',
    area: '180 m²', plot: '300 m²', program: 'Vivienda + estudio',
    desc: 'Casa entre medianeras pensada para un lote típico de La Plata. Patio central que organiza la planta y separa el área pública del descanso. Materialidad simple: ladrillo a la vista, hormigón y carpintería negra.',
  ...
  {
    id: 'sr03', num: 'P—03', title: 'Refugio Sierra', place: 'Concepto · Sierra',
    kind: 'Casa de fin de semana', type: 'residencial', year: '2026', stage: 'Croquis',
    area: '95 m²', plot: '2.000 m²', program: 'Dos cuartos + estar',
    desc: 'Estudio conceptual para una casa mínima en sierra. Volumen único con cubierta a dos aguas, ventanal vidriado al valle. Construcción seca, en madera laminada y chapa.',
  ...
  },
  {
    ...
    kind: 'Comercial · Interiorismo', type: 'comercial', year: '2026', stage: 'Documentación',
  ...
  {
    id: 'cp05', num: 'P—05', title: 'Casa Patio', place: 'Concepto · La Plata',
    kind: 'Vivienda unifamiliar', type: 'residencial', year: '2026', stage: 'Anteproyecto',
    area: '220 m²', plot: '500 m²', program: 'Vivienda 3 dormitorios',
    desc: 'Casa en L con patio principal entre el área social y los dormitorios. Galería continua que protege del sol del oeste. Hormigón visto, carpintería de aluminio negro, piso de cemento alisado.',
