...
interface FormData {
  ...
  proyecto: string; presupuesto: string; cuando: string; mensaje: string;
}
...
function LeadMagnet() {
  ...
  return (
    <section className="nb-leadmag" id="checklist">
      ...
      <form className="nb-leadmag-form" onSubmit={submit}>
        {sent ? (
          <div className="nb-leadmag-form-done">
            ...
            <p className="nb-leadmag-form-sub">Revisá tu casilla. Si no llega en 5 minutos, mirá en spam.</p>
          </div>
        ) : (
          <>
          ...
          <form className="nb-form" onSubmit={submit}>
            {sent ? (
              <div className="nb-form-sent">
                ...
                <h3 style={{ color: 'var(--bone)', fontSize: 28, fontWeight: 300, letterSpacing: '-0.01em', margin: 0 }}>
                  Gracias, {form.nombre || 'te escribimos pronto'}.
                </h3>
                <p>Recibimos tu mensaje. Te respondemos al correo indicado en menos de 48 hs hábiles para coordinar la primera reunión.</p>
                <button
                  type="button" className="nb-btn nb-btn-text"
                  onClick={() => { setSent(false); setForm(FORM_INIT) }}
                >
              ...
              <>
                ...
                <div className="nb-field">
                  ...
                  <textarea
                    rows={4} value={form.mensaje} onChange={update('mensaje')}
