...
const SERVICIOS = [
  { n: '01', t: 'Proyecto', benefit: 'Tu idea se vuelve un plano construible. Documentación técnica y municipal lista para ejecutar.', detail: 'Anteproyecto · Proyecto ejecutivo · Planos municipales · Detalle constructivo' },
  { n: '02', t: 'Dirección de obra', benefit: 'La obra se construye tal como se piensa. Supervisión técnica directa, sin intermediarios.', detail: 'Visitas semanales · Coordinación de gremios · Control de avance y calidad · Informe mensual' },
  { n: '03', t: 'Ejecución de obras', benefit: 'Construcción llave en mano. Vos no coordinas gremios — nosotros respondemos por todo.', detail: 'Equipos propios · Albañilería, instalaciones y terminaciones · Plazo y precio cerrados' },
  { n: '04', t: 'Gestiones municipales', benefit: 'Resolvemos el papeleo para que la obra avance sin sobresaltos.', detail: 'Permisos · Factibilidades · Final de obra · Conexiones · Reglamento de copropiedad' },
  { n: '05', t: 'Interiorismo', benefit: 'El espacio interior diseñado con el mismo criterio que la arquitectura.', detail: 'Materialidad · Mobiliario a medida · Iluminación · Paleta y atmósfera' },
  { n: '06', t: 'Renders', benefit: 'Ver el proyecto antes de construirlo. Decisiones de diseño tomadas con la imagen final a la vista.', detail: 'Render fotorrealista · Recorrido virtual · Render técnico · Material para municipal' },
  { n: '07', t: 'Asesorías', benefit: 'Una opinión técnica clara cuando la necesitás. Consultas, peritajes y dictámenes.', detail: 'Consulta puntual · Peritaje · Dictamen técnico · Revisión de proyecto en curso' },
  { n: '08', t: 'Proyecto de instalaciones', benefit: 'Las instalaciones pensadas con la arquitectura, no después.', detail: 'Sanitaria · Eléctrica · Gas · Termomecánica · Domótica básica' },
]
    ...
    <div className="nb-page">
        ...
        <div className="nb-llave-inner">
          <div>
            ...
            <p className="nb-llave-body">
              ...
              Vos firmás con un solo responsable. Y el criterio que pensó la obra es el mismo que la construye.
            </p>
            <Link
              className="nb-btn"
              href="/contacto"
              style={{ background: 'var(--bone)', color: 'var(--nobra-blue)', borderColor: 'var(--bone)' }}
            >
      ...
      <section style={{ padding: 'clamp(80px,10vw,140px) 0 0', background: 'var(--bone)' }}>
        ...
        <div className="nb-services-page-list">
          {SERVICIOS.map(s => (
            <article key={s.n} className="nb-service-row">
              <div className="nb-service-row-num">{s.n} / 08</div>
              <div>
                <h3 className="nb-service-row-title">{s.t}</h3>
                <div style={{ fontFamily: 'var(--font-mono)', fontSize: 11, color: 'var(--stone-300)', letterSpacing: '0.1em', textTransform: 'uppercase', marginTop: 8 }}>
                  {s.detail}
                </div>
              </div>
      ...
      {/* CTA */}
      <section style={{ padding: 'clamp(80px,10vw,140px) clamp(20px,5vw,80px)', background: 'var(--bone)', textAlign: 'center', borderTop: '1px solid var(--line)' }}>
